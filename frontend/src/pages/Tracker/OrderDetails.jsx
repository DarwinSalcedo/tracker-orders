    ...
    return (
        ...
        >
            <div style={{ marginBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Button variant="secondary" onClick={onBack}>&larr; Track Another</Button>
                ...
                <Card>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem' }}>
                        <div style={{ padding: '1rem', background: 'rgba(16, 185, 129, 0.1)', borderRadius: '50%' }}>
                            <Box size={32} color="var(--color-success)" />
                        </div>
                        <div>
                            <h2 style={{ fontSize: '1.5rem', marginBottom: '0.25rem' }}>{order.status.replace('_', ' ').toUpperCase()}</h2>
                            <p style={{ color: 'var(--color-text-muted)' }}>Current Status</p>
                        </div>
                    </div>
                    ...
                    <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
                        {order.createdAt && (
                            <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                                ...
                                <div>
                                    <p style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)' }}>Created</p>
